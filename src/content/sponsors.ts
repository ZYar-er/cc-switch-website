...
export const sponsors: Sponsor[] = [
  ...
  },
  {
    ...
    description: {
      zh: 'AICoding 提供 Claude Code、GPT、Gemini 及国内主流模型的 API 中转服务，Claude Code 低至 1.9 折、GPT 低至 0.1 折，并支持企业级高并发、极速开票与 7×24 专属技术支持。',
      en: 'AICoding provides API relay access to Claude Code, GPT, Gemini, and major Chinese models, with Claude Code at 19% of the original price and GPT at just 1%. It also supports enterprise-grade concurrency, fast invoicing, and dedicated 24/7 technical support.',
      ja: 'AICoding は Claude Code、GPT、Gemini、中国の主要モデルに対応する API 中継サービスです。Claude Code は 81% オフ、GPT は 99% オフで、エンタープライズ級の高同時接続、迅速な請求書発行、24 時間年中無休の専属テクニカルサポートを提供します。',
    },
    perk: {
  ...
  },
  {
    ...
    url: 'https://www.aicodemirror.ai/register?invitecode=9915W3',
    tier: 'standard',
    category: 'relay',
    featured: true,
    since: '2025-05',
