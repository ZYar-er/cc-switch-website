...
详见 [v3.20.3 更新说明](/zh/changelog/3.20.3)与[添加供应商](/zh/docs?section=providers&item=add)。**下文保留的是旧版 Chat 格式教程与截图，仅供已有 Chat 卡片排障参考，不代表新版预设的配置。**
...
![Codex 供应商列表里的需要路由标记](/docs/assets/codex-kimi-routing/01-codex-providers-require-routing.png)
...
![Kimi Codex 供应商表单中的上游格式设置](/docs/assets/codex-kimi-routing/02-kimi-codex-routing-form.png)
...
![本地路由页面中启用 Codex 接管](/docs/assets/codex-kimi-routing/03-local-route-codex-takeover.png)
...
- [CC Switch 用户手册：添加供应商](/zh/docs?section=providers&item=add)
- [CC Switch 用户手册：代理服务](/zh/docs?section=proxy&item=service)
- [CC Switch 用户手册：应用路由](/zh/docs?section=proxy&item=routing)
