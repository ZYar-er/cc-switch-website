...
![Needs routing marker in the Codex provider list](/docs/assets/codex-kimi-routing/01-codex-providers-require-routing.png)
...
![Upstream format in the Kimi Codex provider form](/docs/assets/codex-kimi-routing/02-kimi-codex-routing-form.png)
...
- [CC Switch User Manual: Add Provider](/en/docs?section=providers&item=add)
- [CC Switch User Manual: Proxy Service](/en/docs?section=proxy&item=service)
- [CC Switch User Manual: App Routing](/en/docs?section=proxy&item=routing)
