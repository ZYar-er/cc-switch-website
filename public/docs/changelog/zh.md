...
- **[添加供应商](/zh/docs?section=providers&item=add)**：Pi 与新预设的入口。
- **[用量统计](/zh/docs?section=proxy&item=usage)**：Pi 会话用量的来源与口径，以及 DeepSeek 调价对读数的影响。
- **[请求路由](/zh/docs?section=proxy&item=routing)**：WebSearch 桥接生效的路由场景。
...
- **[用量统计](/zh/docs?section=proxy&item=usage)**：用量看板的数据来源与统计口径，理解交错计数器多算是怎么发生的、什么情况下需要手动重建。
- **[MCP 管理](/zh/docs?section=extensions&item=mcp)** 与 **[Skills 管理](/zh/docs?section=extensions&item=skills)**：新的搜索与批量开关所在的两个面板。
